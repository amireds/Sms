...
<head>
    ...
    <style>
    	.e_header {
			border-bottom:1px solid #036fa1; padding:10px;
			overflow:auto;
		}
		.e_sub_header {
			padding:10px; margin-bottom:10px; border-bottom:1px solid #036fa1;
		}
		.e_body {
			padding:10px;	
		}
		.e_footer {
			border-top:1px solid #036fa1; padding:10px; margin-top:10px;
		}
		.email_btn {
